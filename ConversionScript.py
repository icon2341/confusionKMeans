...
if __name__ == '__main__':
    ...
    for file in os.listdir("data"):
        ...
        #read all the lines of the file and put into array of strings
        allLines = f.readlines()

        #replace each line with a new line in the correct csv formatting
        lineIndex = 0
        letterIndex = 0
        lineBuilder = ""
        #go through each line of the csv, append the space, then add that the the line builder
        for line in allLines:
            for letter in line:
                if letter == ' ':
                    ...
                    lineBuilder += letter
                letterIndex += 1
            #replace the internal string line
            allLines[lineIndex] = lineBuilder
            lineBuilder = ""
            lineIndex += 1
        ...
        allLines.insert(0, headerLine + "\n")

        print(allLines[0])

        #write each line of the newly built file into the existing csv
