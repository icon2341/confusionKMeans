...
if __name__ == '__main__':
    ...
    # plt.title('Inertia v.s Number of Clusters for Audio Modality')
    # plt.xticks(ks)
    #
    # plt.show()
    ...
    # Using sklearn
    km = sklearn.cluster.KMeans(n_clusters=numberClusters, init='k-means++', n_init=600 )
    ...
    title2d = "KMeans Clustering of Audio Modality Using PC 1 and 2"
    ...
    title = "KMeans Clustering of Audio Modality Using PC 1, 2, and 3"
