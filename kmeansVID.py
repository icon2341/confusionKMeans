...
from plotly.graph_objs.layout.scene import ZAxis, YAxis, XAxis
...
if __name__ == '__main__':
    ...
    # plt.title('Inertia v.s Number of Clusters for Video/Facial Modality')
    # plt.xticks(ks)
    #
    # plt.show()
    ...
    title2d = "KMeans Clustering of Video/Facial Modality Using PC 1 and 2"
    ...
    title = "KMeans Clustering of Video/Facial Modality Using PC 1, 2, and 3"
